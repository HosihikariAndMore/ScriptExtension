...
public struct JsAtom
{
    ...
    public static implicit operator JsAtom(uint id) => new() { Id = id };

    public static bool operator ==(JsAtom left, JsAtom right) => left.Id == right.Id;

    public static bool operator !=(JsAtom left, JsAtom right) => !(left == right);

    public bool Equals(JsAtom other)
    {
        return Id == other.Id;
    }
    ...
    {
        return obj is JsAtom other && Equals(other);
    }
    ...
    public static class BuildIn
    {
        ...
        public static JsAtom FileName = 49;

        //DEF(lineNumber, "lineNumber")
        public static JsAtom LineNumber = 50;
        ...
        /// </summary>
        public static JsAtom Message = 51;

        //DEF(errors, "errors")
        public static JsAtom Errors = 52;

        //DEF(stack, "stack")
        public static JsAtom Stack = 53;

        //DEF(name, "name")
        public static JsAtom Name = 54;

        //DEF(toString, "toString")
        public static JsAtom ToStringFunc = 55;
